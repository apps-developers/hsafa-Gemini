...
# 🎨 Tool Display Configuration (Client-Side)
...
SmartSpaces have **secret key** (`sk_...`) for admin access and **public key** (`pk_...`) for regular access. The client SDK uses this to control prebuilt tool visibility:
