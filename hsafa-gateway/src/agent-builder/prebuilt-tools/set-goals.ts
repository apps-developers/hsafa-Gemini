...
registerPrebuiltTool('setGoals', {
  defaultDescription: 'Set or update your goals. Use this to track objectives, priorities, and progress. You can create new goals, update existing ones, or clear all goals and start fresh.',
